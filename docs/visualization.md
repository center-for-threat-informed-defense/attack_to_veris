...
The mappings for the VERIS framework are provided in a tabular format in Excel spreadsheets. You can find the spreadsheets within the `/frameworks/` folder:
