...
| Data                                       | Description                                                                                                                                                                       |
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [veris-mappings.xlsx](veris-mappings.xlsx) | Lists all of the mappings for this control framework.                                                                                                                             |
| [veris-mappings.json](veris-mappings.json) | Lists all of the mappings for this control framework in JSON format.                                                                                                              |
