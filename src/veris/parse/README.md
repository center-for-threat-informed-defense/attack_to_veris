...
| :------------------ | :----------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------- |
| input-enumerations  | csv file with VERIS entries                                                          | ../../../mappings/veris-1.3.7/input/enterprise/csv/veris1_3_7-enumerations-enterprise.csv |
| input-mappings      | csv file with mappings between VERIS and ATT&CK                                      | ../../../mappings/veris-1.3.7/input/enterprise/csv/veris1_3_7-mappings-enterprise.csv     |
| output-enumerations | output STIX bundle file for the veris entries                                        | ../../../mappings/veris-1.3.7/stix/enterprise/veris1_3_7-enumerations-enterprise.json     |
| output-mappings     | output STIX bundle file for the mappings                                             | ../../../mappings/veris-1.3.7/stix/enterprise/veris1_3_7-mappings-enterprise.json         |
| config-location     | filepath to the configuration for the framework                                      | ../../../mappings/veris-1.3.7/input/config.json                                           |
