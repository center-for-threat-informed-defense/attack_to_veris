...
| [stix](stix) | The STIX 2.0 representation of the data in JSON format. See the [README](stix/README.md) in that folder for more information. |
| [input](input) | 	Input spreadsheets from which the STIX is built. To rebuild the STIX data from the input spreadsheets, run `python parse.py`. See the [README](input/README.md) in that folder for more information. |
